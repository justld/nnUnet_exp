...
if __name__ == '__main__':
    ...
    print('num_pool_per_axis', num_pool_per_axis)
    print('net_num_pool_op_kernel_sizes', net_num_pool_op_kernel_sizes)
    print('net_conv_kernel_sizes', net_conv_kernel_sizes)
    print('patch_size', patch_size)
    print('must_be_divisible_by', must_be_divisible_by)
